      ...
      <main className="flex-1 bg-slate-50">
        <div className="mx-auto max-w-2xl px-4 py-14">
          <div className="text-center">
            ...
            <h1 className="mt-2 text-3xl font-bold text-slate-900 sm:text-4xl">Où en est ma commande ?</h1>
          ...
          <form method="get" className="mx-auto mt-8 flex max-w-md gap-2">
            <input
              ...
              className="min-h-12 w-full rounded-lg border border-slate-300 px-4 text-center font-mono text-lg uppercase tracking-[0.2em] focus:border-orange-500 focus:outline-none"
            />
            <button
              type="submit"
              className="min-h-12 shrink-0 rounded-lg bg-slate-900 px-6 text-sm font-semibold text-white transition hover:bg-slate-800"
            >
              Suivre
            </button>
          </form>
          ...
          {commande && (
            <div className="mt-10 space-y-5">
                      ...
                      <li key={etape.cle} className="flex items-center gap-3">
                        <span
                          ...
                          className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-full text-xs font-bold ${
                            etape.faite ? "bg-orange-500 text-slate-900" : "bg-slate-200 text-slate-400"
                          }`}
                        >
                          {etape.faite ? "✓" : ""}
                        </span>
                        <span
                          className={etape.faite ? "font-medium text-slate-900" : "text-slate-400"}
                        >
                          {etape.libelle}
                        </span>
                      </li>
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-6">
                <h2 className="font-semibold text-slate-900">Le détail</h2>
